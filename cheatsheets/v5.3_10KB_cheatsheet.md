...
- Any TRUE verdict MUST cite a specific rule from 2.1–2.12. Do NOT invent free-form proofs to justify TRUE.
...
DEFAULT: No route in STEPs 2-5 fired → VERDICT: FALSE. REASONING must say "default false fallback".
